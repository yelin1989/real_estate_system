...
<body>
	...
	<nav>
		<a href="agentprofile.jsp?username=<%=session.getAttribute("username")%>">My Home</a>
		<a href="addproperties.jsp">Add Properties</a>
	...
	<div class='body'>
		<div class="container">
			...
			<form id="search-form" action="<%=request.getContextPath()%>/agentshowpropertiesbyregion" method="post">
				<div class="input-box">
